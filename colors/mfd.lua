-- MFD: Military Flight Display theme for Neovim
-- Monotone olive/sage with text decoration for syntax

vim.cmd('highlight clear')
vim.g.colors_name = 'mfd'

local c = {
  bg       = '#7A8B69',  -- olive sage
  fg       = '#1E2D1E',  -- dark forest green
  dim      = '#5A6B49',  -- subtle olive (comments)
...
hi('DiffAdd',      { bg = '#6A7B59' })
hi('DiffChange',   { bg = '#7A8B69' })
hi('DiffDelete',   { fg = c.dim, bg = '#8A7B69' })
hi('DiffText',     { bg = '#5A6B49', bold = true })
...
hi('GitSignsAddInline',     { bg = '#6A7B59' })
hi('GitSignsDeleteInline',  { bg = '#8A7B69' })
