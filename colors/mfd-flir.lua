-- MFD FLIR: White-hot thermal imaging
-- Dark background, soft warm greys - low contrast

vim.cmd('highlight clear')
vim.g.colors_name = 'mfd-flir'

local c = {
  bg       = '#181818',  -- dark grey, not black
  fg       = '#909090',  -- soft mid grey
  dim      = '#404040',  -- grey (comments)
  bright   = '#A8A8A8',  -- hot spots - subtle thermal peaks
  subtle   = '#2E2E2E',  -- barely-there (line numbers)
  visual   = '#242424',  -- selection
  cursor   = '#202020',  -- cursor line
  border   = '#2E2E2E',  -- window borders
...
hi('Cursor',       { fg = c.bg, bg = '#C0C0C0' })
hi('lCursor',      { fg = c.bg, bg = '#C0C0C0' })
hi('CursorIM',     { fg = c.bg, bg = '#C0C0C0' })
hi('TermCursor',   { fg = c.bg, bg = '#C0C0C0' })
hi('TermCursorNC', { fg = c.bg, bg = c.dim })
hi('CursorNormal',  { fg = c.bg, bg = '#C0C0C0' })
hi('CursorInsert',  { fg = c.bg, bg = '#E0E0E0' })
hi('CursorVisual',  { fg = c.bg, bg = '#686868' })
hi('CursorReplace', { fg = c.bg, bg = '#B8B8B8' })
