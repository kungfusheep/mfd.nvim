...
hi("DiffAdd", { fg = c.bg, bg = c.dim, bold = true })
hi("DiffChange", { fg = c.bg, bg = c.dim, bold = true })
hi("DiffDelete", { fg = c.bg, bg = c.fg, bold = true })
hi("DiffText", { bg = c.dim, bold = true })
...
hi("GitSignsAddInline", { bg = c.fg })
hi("GitSignsDeleteInline", { bg = c.dim })
