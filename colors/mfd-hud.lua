...
hi('Comment',      { fg = c.dim, bg = '#091008', italic = true })
hi('Constant',     { fg = c.fg })
...
hi('SpecialComment', { fg = c.dim, bg = '#091008', bold = true, italic = true })
hi('Debug',        { fg = c.fg })
...
hi('@comment',            { fg = c.dim, bg = '#091008', italic = true })
hi('@comment.documentation', { fg = c.dim, bg = '#091008', italic = true })
