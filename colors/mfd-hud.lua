-- MFD HUD: Heads-Up Display symbology
-- Vivid green projected on combiner glass — brighter than CRT

vim.cmd('highlight clear')
vim.g.colors_name = 'mfd-hud'
...
hi('CursorNormal',  { fg = c.bg, bg = '#55BB55' })  -- vivid green, home base
hi('CursorInsert',  { fg = c.bg, bg = '#88EE88' })  -- bright hot green, max pop
hi('CursorVisual',  { fg = c.bg, bg = '#338833' })  -- darker green, selection
hi('CursorReplace', { fg = c.bg, bg = '#70DD70' })  -- bright vivid green, between normal/insert
hi('CursorCommand', { fg = c.bg, bg = '#55BB55' })  -- same as normal
...
hi('DiffAdd',      { bg = '#081A08' })
hi('DiffChange',   { bg = '#0A1008' })
hi('DiffDelete',   { fg = c.dim, bg = '#1A0808' })
hi('DiffText',     { bg = '#102010', bold = true })

-- Syntax: monotone with decoration
hi('Comment',      { fg = comment, bg = '#0E1810', italic = true })
hi('Constant',     { fg = c.fg })
...
hi('SpecialComment', { fg = comment, bg = '#0E1810', bold = true, italic = true })
hi('Debug',        { fg = c.fg })
...
hi('@comment',            { fg = comment, bg = '#0E1810', italic = true })
hi('@comment.documentation', { fg = comment, bg = '#0E1810', italic = true })
...
hi('GitSignsAddInline',     { bg = '#081A08' })
