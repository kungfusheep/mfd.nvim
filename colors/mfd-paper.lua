-- MFD Paper: High contrast military terminal
-- Cream background with dark green text - vintage military equipment

vim.cmd('highlight clear')
vim.g.colors_name = 'mfd-paper'

local c = {
  bg       = '#BBC5B7',  -- greenish gray from reference
  fg       = '#002611',  -- dark forest green from reference
  dim      = '#8A9A88',  -- muted green-gray (comments)
  bright   = '#001008',  -- near black green (emphasis)
  subtle   = '#A5B2A2',  -- lighter green-gray (line numbers)
  visual   = '#A0B0A0',  -- selection
  cursor   = '#B0BAB0',  -- cursor line
  border   = '#95A592',  -- window borders
