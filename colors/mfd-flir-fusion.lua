-- MFD FLIR-Fusion: Thermal fusion imaging
-- Deep purple base, orange/amber heat signatures

vim.cmd('highlight clear')
vim.g.colors_name = 'mfd-flir-fusion'

local c = {
  bg       = '#1A0A20',  -- deep purple-black
  fg       = '#C08840',  -- warm amber
  dim      = '#503060',  -- muted purple (comments)
  bright   = '#E8C050',  -- peak heat - yellow-amber
  subtle   = '#2A1830',  -- dark purple (line numbers)
  visual   = '#241430',  -- selection
  cursor   = '#201028',  -- cursor line
  border   = '#2A1830',  -- window borders
...
hi('CursorNormal',  { fg = c.bg, bg = '#C08840' })
hi('CursorInsert',  { fg = c.bg, bg = '#E8C050' })
hi('CursorVisual',  { fg = c.bg, bg = '#7A4880' })
hi('CursorReplace', { fg = c.bg, bg = '#D09038' })
hi('CursorCommand', { fg = c.bg, bg = '#C08840' })
...
hi('DiffAdd',      { bg = '#1E1028' })
hi('DiffChange',   { bg = '#201228' })
hi('DiffDelete',   { fg = c.dim, bg = '#281020' })
hi('DiffText',     { bg = '#281830', bold = true })
...
hi('@float',              { fg = c.fg })
hi('@function',           { fg = c.bright, bold = true })
hi('@function.builtin',   { fg = c.bright, bold = true, italic = true })
hi('@function.call',      { fg = c.bright })
hi('@function.macro',     { fg = c.bright, bold = true })
hi('@method',             { fg = c.bright, bold = true })
hi('@method.call',        { fg = c.bright })
...
hi('@exception',          { fg = c.fg, bold = true })
hi('@include',            { fg = c.fg, bold = true })
hi('@type',               { fg = c.bright, underline = true })
hi('@type.builtin',       { fg = c.bright, underline = true })
hi('@type.definition',    { fg = c.bright, underline = true })
...
hi('@lsp.type.function',      { fg = c.bright, bold = true })
hi('@lsp.type.method',        { fg = c.bright, bold = true })
...
hi('GitSignsAddInline',     { bg = '#1E1028' })
hi('GitSignsDeleteInline',  { bg = '#281020' })
