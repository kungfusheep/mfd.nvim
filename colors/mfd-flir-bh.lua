-- MFD FLIR-BH: Black-hot thermal imaging
-- Light background, soft dark greys - low contrast inverted

vim.cmd('highlight clear')
vim.g.colors_name = 'mfd-flir-bh'

local c = {
  bg       = '#B8B8B8',  -- mid-light grey
  fg       = '#505050',  -- soft mid grey
  dim      = '#909090',  -- grey (comments)
  bright   = '#383838',  -- cold spots - subtle thermal dips
  subtle   = '#A8A8A8',  -- barely-there (line numbers)
  visual   = '#ACACAC',  -- selection
  cursor   = '#B0B0B0',  -- cursor line
  border   = '#A8A8A8',  -- window borders
...
hi('CursorNormal',  { fg = c.bg, bg = '#606060' })
hi('CursorInsert',  { fg = c.bg, bg = '#484848' })
hi('CursorVisual',  { fg = c.bg, bg = '#808080' })
hi('CursorReplace', { fg = c.bg, bg = '#585858' })
hi('CursorCommand', { fg = c.bg, bg = '#606060' })
...
hi('DiffAdd',      { bg = '#C8CCC8' })
hi('DiffChange',   { bg = '#CCCCCC' })
hi('DiffDelete',   { fg = c.dim, bg = '#CCC8C8' })
hi('DiffText',     { bg = '#C0C0C0', bold = true })
...
hi('GitSignsAddInline',     { bg = '#C8CCC8' })
hi('GitSignsDeleteInline',  { bg = '#CCC8C8' })
